...
private WPI_TalonSRX hopperB;
    ...
    public void tuneHopper() {
      ...
      public void hopperSetPos (double amount) {
          hopperA.set(ControlMode.MotionMagic, amount);
          hopperB.set(ControlMode.MotionMagic, amount);
        }
      ...
      public void hopperSetSpeed (double speed) {
          hopperA.set(ControlMode.PercentOutput, speed);
          hopperB.set(ControlMode.PercentOutput, speed);
      }
