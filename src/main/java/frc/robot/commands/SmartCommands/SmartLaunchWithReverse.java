...
public class SmartLaunchWithReverse extends SequentialCommandGroup {
    
   // CommandGroupBase.addCommands(SequentialCommandGroup);
    

    public SmartLaunchWithReverse(hopper hopper, limelight m_limelight,swerveDrivetrain drivetrain,launcher launcher){
