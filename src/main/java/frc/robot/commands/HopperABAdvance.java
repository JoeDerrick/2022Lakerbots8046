...
public class HopperABAdvance extends ParallelCommandGroup {
    
   // CommandGroupBase.addCommands(SequentialCommandGroup);
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public HopperABAdvance(hopper hopper){
        //hopper = subsystem;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //turn on the intake
           parallel(
            new HopperAdvanceA(hopper, -35000), //<-- value not set in stone
            new HopperAdvanceB(hopper, -35000)
           )
