...
/*
public class SwervePathFollowv3 extends SequentialCommandGroup {
  ...
  public static Trajectory makeTrajectory(
    ...
    CentripetalAccelerationConstraint centripetalAccelerationConstraint =
        new CentripetalAccelerationConstraint(Constants.AutoConstants.kMaxAngularSpeedRadiansPerSecondSquared);
    return TrajectoryGenerator.generateTrajectory(
        waypoints,
        new TrajectoryConfig(
                Math.min(maxVelocity, Constants.AutoConstants.kMaxSpeedMetersPerSecond),
